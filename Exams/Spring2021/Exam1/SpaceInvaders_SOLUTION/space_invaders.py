...
def fire_button_press(button_data):
    button_data["fire"] = True
...
def main():
    ...
    move_left_button = gz.Button(22)
    move_right_button = gz.Button(23)
    fire_button = gz.Button(25)
    button_data = {"fire": False}
    fire_button.when_pressed = lambda : fire_button_press(button_data)
